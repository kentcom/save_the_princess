...
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('A',48,'OLPA')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('B',48,'KLMA')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('C',48,'LLMA')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('D',48,'KLLA')")

conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('A',49,'7,7')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('B',49,'7,9')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('C',49,'9,7')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('D',49,'9.9')")

conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('A',50,'I')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('B',50,'T')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('C',50,'L')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('D',50,'C')")

conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('A',51,'1')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('B',51,'2')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('C',51,'3')")
conn.execute("Insert into Options(OptionID,QuestionID,Options_value) values ('D',51,'None')")
